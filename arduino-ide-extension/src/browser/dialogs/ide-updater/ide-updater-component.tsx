    ...
    <div className="ide-updater-dialog--downloaded">
      <div>
        {nls.localize(
          ...
          'Rudiron IDE {0} has been downloaded.',
          version
        )}
      </div>
      <div>
    ...
    <div className="ide-updater-dialog--downloading">
      <div>
        {nls.localize(
          ...
          'Downloading the latest version of the Rudiron IDE.'
        )}
      </div>
      ...
      <div className="ide-updater-dialog--new-version-text dialogSection">
        ...
        <div className="dialogRow">
          {nls.localize(
            ...
            'A new version of Rudiron IDE ({0}) is available for download.',
            version
          )}
        </div>
        {changelog && (
    ...
    <div className="ide-updater-dialog--go-to-download-page">
      <div>
        {nls.localize(
          ...
          "An update for the Rudiron IDE is available, but we're not able to download and install it automatically. Please go to the download page and download the latest version from there."
        )}
      </div>
    </div>
  );
